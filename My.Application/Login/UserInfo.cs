    ...
    public class UserInfo
    {
        ...
        public static void SetUserInfo(UserInfo info)
        {
            ...
            if (context != null)
            {
                ...
                context.Session["id"] = info.Id.ToString();
        ...
        public static UserInfo GetUserInfo(HttpContext context)
        {
            ...
            else
            {
                    ...
                    if (s["UserGUID"] != null && s["UserName"] != null && s["UserCode"] != null && s["BUGUID"] != null && s["BUName"] != null && s["IsEndCompany"] != null && s["MySessionState"] != null)
                    {
                        userInfo = new UserInfo()
                        {
                            UserName = s["UserName"].ToString(),
                            UserCode = s["UserCode"].ToString(),
                            Id = new Guid(s["id"].ToString()),
