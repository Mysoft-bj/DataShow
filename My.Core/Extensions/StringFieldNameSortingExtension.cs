...
namespace My.Core
{
    public static class StringFieldNameSortingExtension
    {
        ...
        {            // Create a parameter to pass into the Lambda expression (Entity => Entity.OrderByField).     
            ...
            PropertyInfo property; Expression propertyAccess;
        ...
        {
            if (sortExpression.IsNullOrWhiteSpace()) return source as IOrderedQueryable<TEntity>;
            String[] orderFields = sortExpression.Split(','); IOrderedQueryable<TEntity> result = null;
